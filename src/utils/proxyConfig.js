 ...
 *  2. Auto-detected GitHub Codespaces hostname (port 3000)
 *  3. Same-protocol localhost:3000 (default for local dev)
 *
...
export const getProxyBaseUrl = () => {
  ...
  // Rewrite to port 3000 on the same Codespaces host
